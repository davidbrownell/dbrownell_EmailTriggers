...
# Bug Reports
If you experience a problem with our software, please visit [issues](https://github.com/davidbrownell/dbrownell_EmailTriggers/issues) and create a `Bug report`.

# Feature Requests
If you would like to suggest a new feature for our software, please visit [issues](https://github.com/davidbrownell/dbrownell_EmailTriggers/issues) and create a `Feature request`.
